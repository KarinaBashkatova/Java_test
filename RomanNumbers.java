public enum RomanNumbers {
    ...
    LXXXIV(84), LXXXV(85), LXXXVI(86), LXXXVII(87), LXXXVIII(88), LXXXIX(89),
    XC(90), XCI(91), XCII(92), XCIII(93), XCIV(94), XCV(95), XCVI(96), XCVII(97),
    XCVIII(98), XCIX(99), C(100);

    private String transaction;

    RomanNumbers(int transaction) {
        this.transaction = String.valueOf(transaction);
    }
    ...
    public static RomanNumbers getRomanByArabic(String arabic) {
        for (RomanNumbers roman : values()) {
            if (roman.getTransaction().equals(arabic)) {
                return roman;
            }
        }
        throw new IllegalArgumentException("Результат вычисления не может быть меньше единицы");
}}
